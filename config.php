...
$DATABASE = 'manhgapa_n'; // Tên Database *
$USERNAME = 'manhgapa_n'; // User *
$PASSWORD = 'Manh2708'; // Pass User *
$LOCALHOST = 'localhost'; 
$site_domain = 'http://manh.ga/'; // Link Website *
...
function sendCSM($mail_nhan,$ten_nhan,$chu_de,$noi_dung,$bcc){
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'manhhap.tn@gmail.com'; //GMAIL BOT
        $mail->Password = 'manh2708'; // PASS GMAIL BOT
        $mail->SMTPSecure = 'tls';
        $mail->Port = 587;
        $mail->setFrom('manhhap.tn@gmail.com', $bcc); //GMAIL BOT
        $mail->addAddress($mail_nhan, $ten_nhan);
        $mail->addReplyTo('manhhap.tn@gmail.com', $bcc); //GMAIL BOT
        $mail->isHTML(true);
        $mail->Subject = $chu_de;
        $mail->Body    = $noi_dung;
        $mail->CharSet = 'UTF-8';
